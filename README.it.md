...
🇬🇧 [English](README.md) &nbsp; 🇮🇹 Italiano &nbsp; 🇩🇪 [Deutsch](README.de.md) &nbsp; 🇪🇸 [Español](README.es.md) &nbsp; 🇨🇳 [中文](README.zh.md) &nbsp; [🇲🇬 Malagasy ❤️](README.mg.md)
...
- **Multilingua** — disponibile in inglese 🇬🇧, italiano 🇮🇹, tedesco 🇩🇪, spagnolo 🇪🇸, cinese semplificato 🇨🇳 e malgascio 🇲🇬 ❤️. La lingua dell'interfaccia segue automaticamente la lingua del sistema.
